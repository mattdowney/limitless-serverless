<div id="fixed-header" class="w-full z-10">
<div id="fixed-header-container" class="container mx-auto"> 
<div id="inner-header" class="header-nav grid grid-cols-12 gap-0 md:gap-12">
    ...
    <div id="desktop-menu" class="nav hidden lg:block col-span-6 md:col-span-9 text-right">
        <ul>
            <li class="pricing inline ml-8">
                <a
                class="text-white font-medium text-sm hover:text-white/50 transition-all"
                href="/#pricing"
                >Pricing</a
                >
            </li>
            ...
            <li class="case-studies inline ml-8">
                <div class="group inline relative">
                    <a
                        class="text-white font-medium text-sm hover:text-white/100 transition-all inline-flex items-center pb-3"
                        href="/#"
                        >Case Studies</a
                    >
                    ...
                    >
                        <li>
                        <a
                            class="text-white font-medium text-sm text-white/50 hover:text-white/100 transition-all block mb-1"
                            href="/mybite/"
                            >— Mybite</a
                        >
                        </li>
                        <li>
                        <a
                            class="text-white font-medium text-sm text-white/50 hover:text-white/100 transition-all block"
                            href="/platinum-pets/"
                            >— Platinum Pets</a
                        >
                        </li>
