    ...
    /** @lends wp.customHtmlWidgets.CustomHtmlWidgetControl.prototype */ {
      ...
      initialize: function initialize(options) {
        ...
        control.customizeSettingId =
          'widget_' + control.widgetIdBase + '[' + String(control.widgetNumber) + ']';

        control.$el.addClass('custom-html-widget-fields');
        control.$el.html(
          wp.template('widget-custom-html-control-fields')({
            codeEditorDisabled: component.codeEditorSettings.disabled,
          })
        );
        ...
        control.saveButton = control.syncContainer
          .add(control.syncContainer.parent().find('.widget-control-actions'))
      ...
      updateFields: function updateFields() {
        ...
        control.contentUpdateBypassed =
          ...
          (control.editor && control.editor.codemirror.state.focused) ||
        ...
        settings = _.extend({}, component.codeEditorSettings, {
          ...
          onTabNext: function onTabNext() {
            var tabbables = control.syncContainer
              .add(control.syncContainer.parent().find('.widget-position, .widget-control-actions'))
              .find(':tabbable');
