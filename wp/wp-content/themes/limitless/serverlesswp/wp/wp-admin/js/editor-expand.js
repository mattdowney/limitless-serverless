...
(function (window, $, undefined) {
  ...
  $(function () {
    ...
    $document.on('tinymce-editor-init.editor-expand', function (event, editor) {
      ...
      function mceScroll(key) {
        ...
        editorTop =
          heights.adminBarHeight +
          heights.toolsHeight +
          heights.menuBarHeight +
          heights.visualTopHeight;
         ...
         */
        editorBottom =
          heights.windowHeight - (advanced ? heights.bottomHeight + heights.statusBarHeight : 0);
    ...
    function adjust(event) {
      ...
      if (!canPin) {
        if (resize) {
          ...
          $top.css({
            ...
            width:
              contentWrapWidth - borderWidth * 2 - (visual ? 0 : $top.outerWidth() - $top.width()),
          });
        ...
        if (
          ...
          if (visual && $menuBar.length) {
            $menuBar.css({
              ...
              width:
                contentWrapWidth -
                borderWidth * 2 -
                (visual ? 0 : $top.outerWidth() - $top.width()),
            });
          }
          ...
          if (windowPos <= topPos - heights.toolsHeight - heights.adminBarHeight) {
            ...
            windowPos >=
            topPos - heights.toolsHeight - heights.adminBarHeight + editorHeight - buffer
          ) {
            fixedTop = false;
        ...
        if (
          (!fixedBottom || (resize && advanced)) &&
          // Add borderWidth for the border around the .wp-editor-container.
          windowPos + heights.windowHeight <=
            editorPos + editorHeight + heights.bottomHeight + heights.statusBarHeight + borderWidth
        ) {
      ...
      if (
        ...
        if (
          heights.sideSortablesHeight + pinnedToolsTop + sidebarBottom > heights.windowHeight ||
          fixedSideTop ||
          fixedSideBottom
        ) {
          ...
          if (windowPos + pinnedToolsTop <= postBodyTop) {
            ...
            if (windowPos > lastScrollPosition) {
              if (fixedSideTop) {
                ...
                !fixedSideBottom &&
                heights.sideSortablesHeight + $sideSortables.offset().top + sidebarBottom <
                  windowPos + heights.windowHeight
              ) {
                // Pin the bottom.
              ...
              if (fixedSideBottom) {
                ...
                !fixedSideTop &&
                $sideSortables.offset().top >= windowPos + pinnedToolsTop
              ) {
                // Pin the top.
                fixedSideTop = true;
    ...
    function on() {
      ...
      $document
        .on(
          'wp-collapse-menu.editor-expand postboxes-columnchange.editor-expand editor-classchange.editor-expand',
          adjust
        )
      ...
      $textEditor.on(
        'focus.editor-expand input.editor-expand propertychange.editor-expand',
        textEditorResize
      );
      mceBind();
  ...
  $(function () {
    var $body = $(document.body),
      ...
      $slug = $('#edit-slug-box'),
      $slugFocusEl = $slug.find('a').add($slug.find('button')).add($slug.find('input')),
    ...
    function fadeOut(event) {
      ...
      if (
        key === 27 ||
        (key === 87 && event.altKey && ((!isMac && event.shiftKey) || (isMac && event.ctrlKey)))
      ) {
        fadeIn(event);
        return;
      }
          ...
          .on('mouseenter.focus', function () {
            ...
            $window.on('scroll.focus', function () {
              ...
              if (
                ...
                mouseY &&
                scrollY !== nScrollY &&
                (mouseY < editorRect.top - buffer || mouseY > editorRect.bottom + buffer)
              ) {
                fadeIn();
              }
    ...
    function maybeFadeIn() {
      setTimeout(function () {
        ...
        if (
          ...
          (hasFocus($menuWrap) || hasFocus($wrap) || hasFocus($footer))
        ) {
          fadeIn();
        }
      }, 0);
    ...
    $document.on('quicktags-init', function (event, editor) {
      ...
      if (
        ...
        (',' + editor.settings.buttons + ',').indexOf(',dfw,') !== -1
      ) {
