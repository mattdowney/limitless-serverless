    ...
    window.inlineEditPost = {
      ...
      init: function () {
        ...
        $('#bulk-edit')
          .find('fieldset:first')
          .after(beCategories)
          .siblings('fieldset:last')
          .prepend($('#inline-edit .inline-edit-tags-wrap').clone());
        ...
        $('.inline-edit-categories input[name="post_category[]"]').each(function () {
          if (categories[$(this).val()] == checkedPosts.length) {
            ...
            if (!$(this).parent().find('input[name="indeterminate_post_category[]"]').length) {
              ...
              $(this)
                .after(
                  '<input type="hidden" name="indeterminate_post_category[]" value="' +
                    $(this).val() +
                    '">'
                )
                .attr(
                  'aria-label',
                  label.trim() + ': ' + wp.i18n.__('Some selected posts have this category')
                );
            }
          }
        });

        $('.inline-edit-categories input[name="post_category[]"]:indeterminate').on(
          'change',
          function () {
            ...
            $(this)
              ...
              .parent()
              .find('input[name="indeterminate_post_category[]"]')
              .remove();
          }
        );
      ...
      edit: function (id) {
        ...
        if (
          !$(
            ':input[name="post_author"] option[value="' + $('.post_author', rowData).text() + '"]',
            editRow
          ).val()
        ) {
              ...
              if (-1 !== r.indexOf('<tr')) {
                ...
                $(inlineEditPost.what + id)
                  ...
                  .fadeIn(400, function () {
                    ...
                    $(this).find('.editinline').attr('aria-expanded', 'false').trigger('focus');
      ...
      revert: function () {
        ...
        if (id) {
          ...
          if ('bulk-edit' === id) {
            ...
            $('#bulk-edit', $tableWideFat)
              .removeClass('inline-editor')
              .hide()
              .siblings('.hidden')
              .remove();
            $('#bulk-titles').empty();
