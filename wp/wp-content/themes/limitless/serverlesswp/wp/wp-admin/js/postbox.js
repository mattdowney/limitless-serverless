...
(function ($) {
  ...
  window.postboxes = {
    ...
    updateOrderButtonsProperties: function () {
      ...
      moveUpButtons.attr('aria-disabled', 'false').removeClass('hidden');
      moveDownButtons.attr('aria-disabled', 'false').removeClass('hidden');
    ...
    init: function (page, args) {
      ...
      $('.meta-box-sortables').sortable({
        ...
        receive: function (e, ui) {
          if ('dashboard_browser_nag' == ui.item[0].id) $(ui.sender).sortable('cancel');
    ...
    _pb_change: function () {
      ...
      switch (window.orientation) {
        case 90:
        case -90:
          if (!check.length || !check.is(':checked')) this._pb_edit(2);
          break;
        case 0:
        case 180:
          if ($('#poststuff').length) {
